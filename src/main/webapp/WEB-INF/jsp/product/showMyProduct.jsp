...
<%--  	<tr><td>產品名稱</td><td><input type="text" id="name"  value="${product.name}" placeholder="未填寫" size="30"></td></tr> --%>
<%--  	<tr><td>產品價格</td><td><input type="text" id="price"  value="${product.price}" placeholder="未填寫" size="30"></td></tr> --%>
<%--  	<tr><td>產品數量</td><td><input type="date" id="stock" value="${product.stock}" placeholder="未填寫" size="30"></td></tr> --%>
<%--  	<tr><td>產品描述</td><td><input type="date" id="description" value="${product.description}" placeholder="未填寫" size="30"></td></tr> --%>
<%--  	<tr><td>產品照片</td><td><input type="date" id="imgPath" value="${product.imgPath}" placeholder="未填寫" size="30"></td></tr> --%>
<!-- 	</table> -->
