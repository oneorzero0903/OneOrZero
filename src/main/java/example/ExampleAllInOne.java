...
//		System.out.println("cmprChkMacValue-------------------------------------------------------------");
//		System.out.println();
//		System.out.println("apple pay create order: " + postCreateServerOrder());
//		System.out.println("postCreateServerOrder-------------------------------------------------------------");
//		System.out.println();
//		System.out.println("doAction: " + postDoAction());
//		System.out.println("postDoAction-------------------------------------------------------------");
//		System.out.println();
